...
Class RawMouse {
	...
	MouseMoved(wParam, lParam){
		Critical
		; RawInput statics
		static DeviceSize := 2 * A_PtrSize, iSize := 0, sz := 0, pcbSize:=8+2*A_PtrSize, offsets := {x: (20+A_PtrSize*2), y: (24+A_PtrSize*2), btn: (12+A_PtrSize*2)}, uRawInput
		...
		btn := NumGet(&uRawInput, offsets.btn, "UInt")
 
		this.Callback.(ThisMouse, x, y, btn)
	}
